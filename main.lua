...
local GameList = {
	["9584852943"]  = { id = "61e0f394c005902cda5643069ac59226", keyless = true },  -- +1 Speed Keyboard Escape
	...
	["88070565"]  = { id = "c1ee612d7accf314c53044a4c619bc42", keyless = true },  -- Bloxburg
	...
	["66654135"]   = { id = "7e507d3a7f3171633e9840c1db2c9cf3", keyless = true },  -- Murder Mystery 2
...
local Library do
	...
	local function GetTextSize(Text, Width)
		local Success, Result = pcall(function()
			return TextService:GetTextSize(Text, 14, Font.new("GothamBold"), Vector2New(Width, 10000))
		end)
	...
	Library.Notification = function(self, Data)
		...
		local function GetTextSize(Text, FontSize, Width)
			local Font = Font.new("GothamBold")
